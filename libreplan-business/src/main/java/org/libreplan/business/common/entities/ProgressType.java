...
public enum ProgressType {
    ...
    ALL_NUMHOURS(helperi18n("Progress with all tasks by hours")),
    CRITICAL_PATH_NUMHOURS(helperi18n("Progress with critical path tasks by hours")),
    CRITICAL_PATH_DURATION(helperi18n("Progress with critical path tasks by duration"));
