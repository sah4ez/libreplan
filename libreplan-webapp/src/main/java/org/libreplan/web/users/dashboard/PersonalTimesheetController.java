...
public class PersonalTimesheetController extends GenericForwardComposer implements IPersonalTimesheetController {
    ...
    private RowRenderer rowRenderer = new RowRenderer() {
                        ...
                        new Util.Setter<String>() {
                            ...
                            public void set(String value) {
                                ...
                                if ( effortDuration == null ) {
                                    throw new WrongValueException(textbox, helperi18n("Invalid Effort Duration"));
                                }
                    ...
                    value -> {
                        ...
                        if ( effortDuration == null ) {
                            throw new WrongValueException(
                                    personalTimesheetPopupEffort, helperi18n("Invalid Effort Duration"));
                        }
        ...
        private void renderTotalRow(Row row) {
            appendLabelSpaningTwoColumns(row, helperi18n("Total"));
        ...
        private void renderOtherRow(Row row) {
            appendLabelSpaningTwoColumns(row, helperi18n("Other"));
        ...
        private void renderCapacityRow(Row row) {
            appendLabelSpaningTwoColumns(row, helperi18n("Capacity"));
        ...
        private void renderExtraRow(Row row) {
            appendLabelSpaningTwoColumns(row, helperi18n("Extra"));
...
//            cell.setAlign(ALIGN_CENTER);
    ...
    private void setBreadcrumbs(Component comp) {
        ...
        breadcrumbs.appendChild(new Label(helperi18n("My account")));

        breadcrumbs.appendChild(new Image(BREADCRUMBS_SEPARATOR));
        breadcrumbs.appendChild(new Label(helperi18n("My dashboard")));

        breadcrumbs.appendChild(new Image(BREADCRUMBS_SEPARATOR));
        breadcrumbs.appendChild(new Label(helperi18n("Personal timesheet")));
    }
    ...
    private void createProjectAndTaskColumns() {
        ...
        Column project = new Column(helperi18n("Project"));
        project.setWidth("150px");

        columns.appendChild(project);

        Column task = new Column(helperi18n("Task"));
        task.setWidth("150px");
    ...
    public void previousPeriod() {
        if ( personalTimesheetModel.isModified() ) {
            throw new WrongValueException(previousPeriod,
                    helperi18n("There are unsaved changes in the current personal timesheet, please save before moving"));
        }
...
class PersonalTimesheetRow {
    ...
    public static PersonalTimesheetRow createOrderElementRow(OrderElement orderElemement) {
        ...
        Assert.notNull(orderElemement, "order element empyt..");
