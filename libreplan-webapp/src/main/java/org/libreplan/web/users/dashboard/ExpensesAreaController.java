        ...
        public void render(Row row, Object data, int i) throws Exception {
            ...
            Util.appendOperationsAndOnClickEvent(
                    ...
                    event ->  {
                        try {
                            if (Messagebox.show(
                                    helperi18n("Delete expense sheet \"{0}\". Are you sure?", expenseSheet.getHumanId()),
                                    helperi18n("Confirm"),
                                ...
                                messagesForUser.showMessage(
                                        Level.INFO, helperi18n("Expense sheet \"{0}\" deleted", expenseSheet.getHumanId()));
                            ...
                            messagesForUser.showMessage(
                                    Level.ERROR,
                                    helperi18n("Expense sheet \"{1}\" could not be deleted, it was already removed",
