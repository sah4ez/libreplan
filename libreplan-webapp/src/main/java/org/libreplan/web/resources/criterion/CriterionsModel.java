...
public class CriterionsModel extends IntegrationEntityModel implements ICriterionsModel {
    ...
    public ICriterionType<?> getTypeFor(Criterion criterion) {
        ...
        throw new RuntimeException(helperi18n("{0} not found type for criterion ", criterion));
    }
    ...
    private <T extends Resource> List<T> getResourcesSatisfying(
        ...
        Validate.notNull(resourceType, helperi18n("Resource type cannot be empty"));
        Validate.notNull(criterion, helperi18n("Criterion cannot be empty"));
