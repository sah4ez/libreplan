...
public class CostCategoryCRUDController extends BaseCRUDController<CostCategory> {
    ...
    private void showInvalidValue(HourCost hourCost) {
        ...
        if (row != null) {
            ...
            if (hourCost.getPriceCost() == null) {
                throw new WrongValueException(getPricePerHour(row), helperi18n("cannot be empty"));
            }
        }
    }
    ...
    private void appendDecimalboxCost(Row row) {
        ...
        boxCost.setConstraint("no empty:" + helperi18n("cannot be empty"));
    ...
    protected String getEntityType() {
        return helperi18n("Cost Category");
    }

    @Override
    protected String getPluralEntityType() {
        return helperi18n("Cost Categories");
    }
