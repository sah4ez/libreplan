...
public class ResourcesLoadTabCreator {
    ...
    private ITab createOrderResourcesLoadTab() {
        ...
        return new CreatedOnDemandTab(helperi18n(RESOURCES_LOAD), "order-load", componentCreator) {
            ...
            protected void afterShowAction() {
                ...
                breadcrumbs.appendChild(new Image(BREADCRUMBS_SEPARATOR));
                breadcrumbs.appendChild(new Label(helperi18n(RESOURCES_LOAD)));
                breadcrumbs.appendChild(new Image(BREADCRUMBS_SEPARATOR));
    ...
    private ITab createGlobalResourcesLoadTab() {
        ...
        return new CreatedOnDemandTab(helperi18n(RESOURCES_LOAD), "company-load", componentCreator) {
            @Override
