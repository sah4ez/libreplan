...
public class OrdersTabCreator {
    ...
    private final String PROJECT_DETAILS = helperi18n("Project Details");
    ...
    private ITab createGlobalOrdersTab() {
        return new CreatedOnDemandTab(helperi18n("Projects List"), "orders",
                ordersTabCreator) {
            @Override
            ...
            protected void afterShowAction() {
                ...
                breadcrumbs.appendChild(new Image(BREADCRUMBS_SEPARATOR));
                breadcrumbs.appendChild(new Label(helperi18n("Projects List")));
            }
        };
    }
