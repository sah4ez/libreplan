...
public class LimitingResourcesTabCreator {
    ...
    private ITab createGlobalLimitingResourcesTab() {
        ...
        return new CreatedOnDemandTab(helperi18n("Queue-based Resources Planning"), "limiting-resources", componentCreator) {
            @Override
            ...
            protected void afterShowAction() {
                ...
                breadcrumbs.appendChild(new Image(BREADCRUMBS_SEPARATOR));
                breadcrumbs.appendChild(new Label(helperi18n("Queue-based Resources Planning")));
            }
        };
    }
