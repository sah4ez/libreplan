...
public class DashboardTabCreator {
    ...
    private ITab createDashboardTab() {
        ...
        return new CreatedOnDemandTab(helperi18n("Dashboard"), "order-dashboard",
                componentCreator) {
            ...
            protected void afterShowAction() {
                ...
                breadcrumbs.appendChild(new Image(BREADCRUMBS_SEPARATOR));
                breadcrumbs.appendChild(new Label(helperi18n("Dashboard")));
                breadcrumbs.appendChild(new Image(BREADCRUMBS_SEPARATOR));
    ...
    private ITab createDashboardGlobalTab(){
        ...
        return new CreatedOnDemandTab(helperi18n("Dashboard"), "global-dashboard",
                componentCreator) {
