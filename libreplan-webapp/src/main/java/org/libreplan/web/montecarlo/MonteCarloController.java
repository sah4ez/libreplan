    ...
    public void doAfterCompose(org.zkoss.zk.ui.Component comp) throws Exception {
        ...
        btnRunMonteCarlo.addEventListener(Events.ON_CLICK, new EventListener() {
            ...
            private int getIterations() {
                ...
                if ( iterations == 0 ) {
                    throw new WrongValueException(ibIterations, helperi18n("cannot be empty"));
                }

                if ( iterations < 0 || iterations > MAX_NUMBER_ITERATIONS ) {
                    throw new WrongValueException(ibIterations, helperi18n("Number of iterations should be between 1 and {0}",
            ...
            private void validateRowsPercentages() {
                ...
                for (Object each : rows.getChildren()) {
                    ...
                    if ( sum != 100 ) {
                        ...
                        throw new WrongValueException(row, helperi18n("Percentages should sum 100"));
                    }
    ...
    public Constraint getCheckConstraintIterationNumber() {
        return (comp, value) -> {
            ...
            if (iterationNumber == -1) {
                ...
                throw new WrongValueException(comp, helperi18n("Number of iterations should be between 1 and {0}",
                        MAX_NUMBER_ITERATIONS));
            }
        };
    }
