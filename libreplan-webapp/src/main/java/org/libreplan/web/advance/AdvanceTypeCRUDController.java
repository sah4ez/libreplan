...
public class AdvanceTypeCRUDController extends BaseCRUDController<AdvanceType> {
    ...
    public Constraint lessThanDefaultMaxValue() {
        return (comp, value) -> {
            if (value == null) {
                throw new WrongValueException(comp, helperi18n("Value is not valid, the precision value must not be empty"));
            }

            if (!(advanceTypeModel.isPrecisionValid((BigDecimal) value))) {
                throw new WrongValueException(
                        comp, helperi18n("Invalid value. Precission value must be lower than the Default Max value."));
            }
        };
    }
    ...
    public Constraint greaterThanPrecision() {
        return (comp, value) -> {
            if (value == null) {
                throw new WrongValueException(comp, helperi18n("Invalid value. Default Max Value cannot be empty"));
            }
            if (!(advanceTypeModel.isDefaultMaxValueValid((BigDecimal) value))) {
                throw new WrongValueException(
                        comp,
                        helperi18n("Value is not valid, the default max value must be greater than the precision value "));
            }
        };
    }
    ...
    public Constraint distinctNames() {
        return (comp, value) -> {
            if (((String) value).isEmpty()) {
                throw new WrongValueException(comp, helperi18n("The name is not valid, the name must not be null "));
            }

            if (!advanceTypeModel.distinctNames((String) value)) {
                throw new WrongValueException(
                        comp,
                        helperi18n("The name is not valid, there is another progress type with the same name. "));
            }
        };
    ...
    protected String getEntityType() {
        return helperi18n("Progress Type");
    }

    @Override
    protected String getPluralEntityType() {
        return helperi18n("Progress Types");
    }
