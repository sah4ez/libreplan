...
public class MaterialsController extends GenericForwardComposer {
    ...
    private void appendDeleteButton(final Treeitem ti) {
        ...
        btnDelete.setTooltiptext(helperi18n("Delete"));
    ...
    public void confirmRemove(MaterialCategory materialCategory) {
        ...
        int status = Messagebox.show(helperi18n("Confirm deleting {0}. Are you sure?",
                materialCategory.getName()), helperi18n("Delete"),
    ...
    public void addMaterialCategory() {
        ...
        if (categoryName == null || categoryName.isEmpty()) {
            throw new WrongValueException(txtCategory, helperi18n("cannot be empty"));
        }
    ...
    public void addMaterialToMaterialCategory(Treeitem treeitem) {
        if (treeitem == null) {
            throw new WrongValueException(btnAddMaterial, helperi18n("Cannot insert material in general view. Please, select a category"));
        }
    ...
    public void saveAndContinue() {
        if (save()) {
            messagesForUser.showMessage(Level.INFO, helperi18n("Materials saved"));
            ...
            if (bean instanceof MaterialCategory) {
                ...
                if (treeitem != null) {
                    if (each.getPropertyPath().equals("name")) {
                        throw new WrongValueException(getCategoryTextbox(treeitem), helperi18n(each.getMessage()));
                    }
                    if (each.getPropertyPath().equals("code")) {
                        throw new WrongValueException(getCategoryCodeTextbox(treeitem), helperi18n(each.getMessage()));
                    }
                }
            }
        }
    ...
    private void refreshMaterialsListTitle() {
        ...
        if (treeitem != null) {
            materialsCaption.setLabel(
                    helperi18n("List of materials for category: {0}", ((MaterialCategory) treeitem.getValue()).getName()));
        }
        else {
            materialsCaption.setLabel(helperi18n("List of materials for all categories (select one to filter)"));
        }
    }
    ...
    public void remove(Material material) {
        if(materialsModel.canRemoveMaterial(material)) {
            ...
            messagesForUser.showMessage(Level.ERROR, helperi18n("Cannot delete that material because it is assigned to a project."));
        }
    }
