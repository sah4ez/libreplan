...
public class ProjectDetailsController extends GenericForwardComposer<Component> {
    ...
    private void showWrongValue() {
        throw new WrongValueException(initDate, helperi18n("cannot be empty"));
    }

    private void showWrongName() {
        throw new WrongValueException(txtName, helperi18n("project name already being used"));
    }
    ...
    public Constraint checkConstraintStartDate() {
        return (comp, value) -> {
            ...
            if ( startBefore2010 ) {
                initDate.setValue(null);
                getOrder().setInitDate(null);
                throw new WrongValueException(comp, helperi18n("Must be after 2010!"));
            }
        };
    }
    ...
    public void setTemplate(OrderTemplate template) {
        ...
        if (template == null) {
            ...
            generateCode.setTooltiptext(helperi18n("Set Code as autogenerated to create a new project from templates"));
