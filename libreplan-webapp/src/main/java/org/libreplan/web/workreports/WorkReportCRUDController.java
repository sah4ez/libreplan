...
public class WorkReportCRUDController
    ...
    private void showMessageIfPersonalTimesheetWasSaved() {
        ...
        if ( !StringUtils.isBlank(timesheetSave) ) {
            messagesForUser.showMessage(Level.INFO, helperi18n("Personal timesheet saved"));
        }
    }
    ...
    public void showConfirmDelete(WorkReportDTO workReportDTO) {
        ...
        int status = Messagebox.show(
                helperi18n("Confirm deleting {0}. Are you sure?", workReportName),
                "Delete", Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION);

        if ( Messagebox.OK == status ) {
            workReportModel.remove(workReport);
            messagesForUser.showMessage(Level.INFO, helperi18n("Timesheet removed successfully"));
    ...
    public boolean save() {
        ...
        try {
            ...
            messagesForUser.showMessage(Level.INFO, helperi18n("Timesheet saved"));
    ...
    private boolean validateWorkReport() {
        ...
        if ( !getWorkReport().isDateMustBeNotNullIfIsSharedByLinesConstraint() ) {
            ...
            showInvalidMessage(datebox, helperi18n("cannot be empty"));

            return false;
        }

        if ( !getWorkReport().isResourceMustBeNotNullIfIsSharedByLinesConstraint() ) {
            showInvalidMessage(autocompleteResource, helperi18n("cannot be empty"));

            return false;
        }

        if ( !getWorkReport().isOrderElementMustBeNotNullIfIsSharedByLinesConstraint() ) {
            showInvalidMessage(bandboxSelectOrderElementInHead, helperi18n("cannot be empty"));
    ...
    private boolean validateWorkReportLine(Row row, WorkReportLine workReportLine) {
        ...
        if ( getWorkReportType().getDateIsSharedByLines() ) {
            ...
            if ( date != null ) {
                String message = helperi18n("cannot be empty");
        ...
        if ( workReportLine.getEffort() == null ) {
            ...
            if ( effort != null &&
                ...
                String message = helperi18n("Effort must be greater than zero");
        ...
        if ( !workReportLine.isHoursCalculatedByClockConstraint() ) {
            ...
            if ( effort != null ) {
                String message = helperi18n("effort is not properly calculated based on clock");
                showInvalidMessage(effort, message);
            }
        ...
        if ( workReportLine.getTypeOfWorkHours() == null ) {
            ...
            if ( autoTypeOfHours != null ) {
                ...
                String message = autoTypeOfHours.getItems().isEmpty() ?
                        helperi18n("Hours types are empty. Please, create some hours types before proceeding") :
                        helperi18n("cannot be empty");
        ...
        if ( !workReportLine.isOrderElementFinishedInAnotherWorkReportConstraint() ) {
            ...
            if ( checkboxFinished != null ) {
                String message = helperi18n("task is already marked as finished in another timesheet");
    ...
    public void goToCreateForm(WorkReportType workReportType) {
        if ( workReportType.isPersonalTimesheetsType() ) {
            ...
            createWindow.setTitle(helperi18n("Create Timesheet"));
    ...
    public void goToEditForm(WorkReport workReport) {
        if (SecurityUtils.isSuperuserOrUserInRoles(UserRole.ROLE_TIMESHEETS)) {
            ...
            createWindow.setTitle(helperi18n("Edit Timesheet"));
            loadComponents(createWindow);
            prepareWorkReportList();
            getVisibility().showOnly(createWindow);
            Util.reloadBindings(createWindow);
                ...
                messagesForUser.showMessage(Level.WARNING, helperi18n("You do not have permissions to edit this timesheet"));
        }
    }    	
    ...
    private void appendColumns(Grid grid) {
        ...
        if ( getWorkReport() != null ) {
            if ( !getWorkReport().getWorkReportType().getDateIsSharedByLines() ) {
                ...
                columnDate.setLabel(helperi18n("Date"));
            ...
            if ( !getWorkReport().getWorkReportType().getResourceIsSharedInLines() ) {
                ...
                columnResource.setLabel(helperi18n("Resource"));
            ...
            if ( !getWorkReport().getWorkReportType().getOrderElementIsSharedInLines() ) {
                ...
                columnCode.setLabel(helperi18n("Task"));
            ...
            for (Object fieldOrLabel : workReportModel.getFieldsAndLabelsLineByDefault()) {
                ...
                columnFieldOrLabel.setLabel(helperi18n(columnName));
            ...
            if ( !getWorkReport().getWorkReportType().getHoursManagement()
                ...
                columnHourStart.setLabel(helperi18n("Start hour"));
                ...
                columnHourFinish.setLabel(helperi18n("Finish Hour"));
        ...
        columnNumHours.setLabel(helperi18n("Hours"));
        ...
        columnHoursType.setLabel(helperi18n("Hours type"));
        ...
        columnFinsihed.setLabel(helperi18n("Done"));
        columnFinsihed.setSclass("finished-column");
        columnFinsihed.setTooltiptext(helperi18n("Task finished"));
        NewDataSortableColumn columnCode = new NewDataSortableColumn();
        columns.appendChild(columnFinsihed);
        columnCode.setLabel(helperi18n("Code"));
        columnCode.setSclass("code-column");
        columnCode.setHflex("1");
        columns.appendChild(columnCode);
        NewDataSortableColumn columnOperations = new NewDataSortableColumn();
        columnOperations.setLabel(helperi18n("Op."));
        columnOperations.setSclass("operations-column");
        columnOperations.setTooltiptext(helperi18n("Operations"));
    ...
    public void checkCannotBeHigher(Timebox starting, Timebox ending) {
        ...
        if ( endingDate == null || startingDate == null || startingDate.compareTo(endingDate) > 0 ) {
            throw new WrongValueException(starting, helperi18n("Cannot be higher than finish hour"));
        }
    }

    public void confirmRemove(WorkReportLine workReportLine) {
        int status = Messagebox.show(
                helperi18n("Confirm deleting {0}. Are you sure?", getWorkReportLineName(workReportLine)),
    ...
    public class WorkReportListRenderer implements RowRenderer {
        ...
        private void setHoursType(WorkReportLine workReportLine, Listitem item) {
            ...
            if (value == null && item != null) {
                throw new WrongValueException(item.getParent(), helperi18n("Please, select an item"));
            }
        }
        ...
        private void appendEffortDuration(Row row) {
            ...
            effort.setConstraint((comp, value) -> {
                if ( !Pattern.matches("(\\d+)(\\s*:\\s*\\d+\\s*)*", (String) value))
                    throw new WrongValueException(comp, helperi18n("Please, enter a valid effort"));
            });
        ...
        private void changeResourceInLines(final Autocomplete autocomplete, Row row) {
            ...
            if ( (comboitem == null) || (comboitem.getValue() == null)) {
                ...
                throw new WrongValueException(autocomplete, helperi18n("Please, select an item"));
            } else {
    ...
    public Constraint checkConstraintFinishDate() {
        return (comp, value) -> {
            ...
            if ( (finishDate != null) &&
                ...
                throw new WrongValueException(comp, helperi18n("must be later than start date"));
            }
        };
    }
    ...
    public Constraint checkConstraintStartDate() {
        return (comp, value) -> {
            ...
            if ( (startDate != null) &&
                ...
                throw new WrongValueException(comp, helperi18n("must be before end date"));
            }
        };
    }
    ...
    public void onCreateNewWorkReport() {
        ...
        if ( selectedItem == null ) {
            throw new WrongValueException(listTypeToAssign, helperi18n("please, select a timesheet template type"));
        }
    ...
    public void createOrEditPersonalTimesheet() {
        ...
        if ( date == null ) {
            throw new WrongValueException(personalTimesheetsDatebox, helperi18n("Please set a date"));
        }
        Resource resource = (Resource) personalTimesheetsBandboxSearch.getSelectedElement();
        if ( resource == null ) {
            throw new WrongValueException(personalTimesheetsBandboxSearch, helperi18n("Please select a worker"));
        }
