...
public class BaseCalendarCRUDController extends GenericForwardComposer {
    ...
    public void save() {
        try {
            ...
            messagesForUser.showMessage(
                    Level.INFO, helperi18n("Base calendar \"{0}\" saved", baseCalendarModel.getBaseCalendar().getName()));
    ...
    public class BaseCalendarsTreeitemRenderer implements TreeitemRenderer {
        ...
        public void render(Treeitem item, Object data, int i) {
            ...
            createDerivedButton.setTooltiptext(helperi18n("Create derived"));
            ...
            createCopyButton.setTooltiptext(helperi18n("Create copy"));
            ...
            editButton.setTooltiptext(helperi18n("Edit"));
            ...
            removeButton.setTooltiptext(helperi18n("Remove"));
        ...
        private void confirmRemove(BaseCalendar calendar) {
            ...
            if (hasParent(calendar)) {
                messagesForUser.showMessage(
                        Level.ERROR, helperi18n("Calendar cannot be removed as it has other derived calendars from it"));
                return;
            }
            ...
            if (isDefault(calendar)) {
                messagesForUser.showMessage(
                        Level.ERROR,
                        helperi18n("Default calendar cannot be removed. "
        ...
        private void removeCalendar(BaseCalendar calendar) {
            if (!isReferencedByOtherEntities(calendar)) {
                ...
                if (result == Messagebox.OK) {
                    ...
                    messagesForUser.showMessage(Level.INFO, helperi18n("Removed calendar \"{0}\"", calendarName));
                    Util.reloadBindings(listWindow);
                }
            }
        }
        ...
        private int showConfirmDeleteCalendar(BaseCalendar calendar) {
            return Messagebox.show(
                    helperi18n("Confirm deleting {0}. Are you sure?", calendar.getName()),
    ...
    public void updateWindowTitle() {
        if (editWindow != null && state != CRUDControllerState.LIST) {
            String entityType = helperi18n("Calendar");
