...
public abstract class TreeComponent extends HtmlMacroComponent {
    ...
    protected Column codeColumn = new Column(helperi18n("Code"), "code") {
        @Override
    ...
    protected final Column nameAndDescriptionColumn = new Column(helperi18n("Name"), "name") {
        @Override
        public <T extends ITreeNode<T>> void doCell(TreeController<T>.Renderer renderer, Treeitem item, T currentElement) {
    ...
    protected final Column operationsColumn = new Column(helperi18n("Op."), "operations", helperi18n("Operations")) {
        @Override
        public <T extends ITreeNode<T>> void doCell(TreeController<T>.Renderer renderer, Treeitem item, T currentElement) {
    ...
    protected final Column schedulingStateColumn = new Column(
            helperi18n("Scheduling state"),
            "scheduling_state",
            helperi18n("Fully, Partially or Unscheduled. (Drag and drop to move tasks)")) {
