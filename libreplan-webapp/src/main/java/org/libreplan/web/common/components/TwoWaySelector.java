...
public class TwoWaySelector extends HtmlMacroComponent {
     ...
     */
    private String assignedTitle = helperi18n("Assigned");
     ...
     */
    private String unassignedTitle = helperi18n("Unassigned");
            ...
            if (columns != null) {
                ...
                for (String column : columns) {
                    ...
                    if (propertyDescriptor == null) {
                        throw new RuntimeException(helperi18n("Unknown attribute '{0}' in class {1}", column, klass.getName()));
                    }
