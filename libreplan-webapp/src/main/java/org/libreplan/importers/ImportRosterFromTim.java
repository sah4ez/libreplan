...
public class ImportRosterFromTim implements IImportRosterFromTim {
    ...
    public List<SynchronizationInfo> importRosters() throws ConnectorException {
        ...
        if (StringUtils.isBlank(departmentIds)) {
            ...
            throw new ConnectorException(helperi18n("No departments configured"));
        }
                ...
                .runOnAnotherTransaction(new IOnTransaction<Void>() {
                    ...
                    public Void execute() {
                        ...
                        if (!rosterExceptions.isEmpty()) {
                            ...
                            synchronizationInfo
                                    .addFailedReason(helperi18n("No roster-exceptions found in the response"));
                        }
                        return null;
                    }
                });
    ...
    private CalendarExceptionType getCalendarExceptionType(String name) {
        if (name == null || name.isEmpty()) {
            ...
            synchronizationInfo
                    .addFailedReason(helperi18n("Exception name should not be empty"));
            return null;
        }
        try {
            ...
            synchronizationInfo
                    .addFailedReason(helperi18n("Calendar exception day not found"));
        }
        return null;
    }
